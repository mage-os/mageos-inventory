...
namespace Magento\InventoryReservations\Model\GetReservationsQuantity;
...
class CacheStorage implements ResetAfterRequestInterface
{
     ...
     * @return float|null
     */
    public function get(string $sku, int $stockId): ?float
    {
     ...
     * @param float $value
     */
    public function set(string $sku, int $stockId, float $value): void
    {
